#!/usr/bin/env python3
"""Render the Pydantic modules from tools/pydantic_topics.py.
...
The article text is written to content/articles/pydantic/ where
build_articles.py picks it up, and the questions reach build_labs.py through
tools/labs.py.

    python3 tools/build_pydantic_topics.py
"""
...
from pydantic_topics import TOPICS
...
def main():
    ...
    print("pydantic pages written : %d" % len(TOPICS))
